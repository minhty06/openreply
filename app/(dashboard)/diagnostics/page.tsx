  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title={t("Campaign DM Failures And Skips (last 30 days)")}>
        ...
        <Section title={t("Webhook Failures (last 30 days)")}>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Section title={t("Token Refresh Failures (last 30 days)")}>
